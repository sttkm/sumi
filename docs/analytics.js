    ...
    var y = /:[0-9]+$/,
        A = function(a, b) {
            ...
            case "path":
                ...
                a = a.split("/");
                a:
                if (b = a[a.length - 1], c = [], Array.prototype.indexOf)
    ...
    var ba = function(a, b, c) {
            ...
            if (r.history && r.history.replaceState) {
                ...
                if (f.test(b) || f.test(c))
                    a = A(a, "path"), b = d(b, "?"), c = d(c, "#"), r.history.replaceState({}, void 0, "" + a + b + c)
            }
        },
        T = function(a) {
            var b = void 0 === b ? 3 : b;
                    ...
                    d[1])), c)
                        ...
                        if (d = c.indexOf("."), -1 == d)
                            ...
                            if (c = be("_gac", !!a.get(cc)))
                                c = c.split("."), "1" != c[0] || 4 != c.length ? J(72) : ke(c[3], c[1]) ? J(71) : (a.data.set(ce, c[3]), a.data.set(fe,
                                c[2]), J(70))
                        }
                } else
                    J(21);
            ...
            if (!ea(Yd.get(b)) && !$d.get(b)) {
                ...
                if (c) {
                    ...
                    a || a == d || ("http:" != a ? 0 : "http:" == d)) && B(ca)) {
                        if (ca = ca.url)
                            a = (a = M.querySelector && M.querySelector("script[nonce]") || null) ? a.nonce || a.getAttribute && a.getAttribute("nonce") || "" : "", e ? (e = "", a && Nd.test(a) && (e = ' nonce="' + a + '"'), f.test(ca) && M.write("<script" + e + ' src="' + ca + '">\x3c/script>')) : (e = M.createElement("script"), e.type = "text/javascript", e.async = !0, e.src = ca, a && e.setAttribute("nonce", a), ca = M.getElementsByTagName("script")[0], ca.parentNode.insertBefore(e, ca));
                        $d.set(b, !0)
                    }
                }
            }
